      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 mb-10">
          ...
          <div className="space-y-5">
            <div>
              <h3 className="text-2xl sm:text-3xl font-bold text-white mb-3 bg-gradient-to-r from-orange-400 to-orange-600 bg-clip-text text-transparent">
                KITENGE BORA
              </h3>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                <a
                  ...
                  className="group w-11 h-11 rounded-xl bg-[#1877F2] hover:bg-[#166FE5] flex items-center justify-center transition-all shadow-lg hover:shadow-xl hover:scale-110"
                  aria-label="Facebook"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group w-11 h-11 rounded-xl bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#FCB045] hover:from-[#6B2F94] hover:via-[#E01A1A] hover:to-[#E09A3A] flex items-center justify-center transition-all shadow-lg hover:shadow-xl hover:scale-110"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group w-11 h-11 rounded-xl bg-black hover:bg-gray-900 flex items-center justify-center transition-all shadow-lg hover:shadow-xl hover:scale-110 border border-gray-800"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group w-11 h-11 rounded-xl bg-[#FF0000] hover:bg-[#E60000] flex items-center justify-center transition-all shadow-lg hover:shadow-xl hover:scale-110"
                  aria-label="YouTube"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group w-11 h-11 rounded-xl bg-[#25D366] hover:bg-[#20BA5A] flex items-center justify-center transition-all shadow-lg hover:shadow-xl hover:scale-110"
                  aria-label="WhatsApp"
                >
