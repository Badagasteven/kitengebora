            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                <a
                  ...
                  className="group w-12 h-12 rounded-xl bg-gradient-to-br from-[#1877F2] to-[#166FE5] hover:from-[#166FE5] hover:to-[#1877F2] flex items-center justify-center transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-110 hover:-translate-y-1"
                  aria-label="Facebook"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group w-12 h-12 rounded-xl bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#FCB045] hover:from-[#6B2F94] hover:via-[#E01A1A] hover:to-[#E09A3A] flex items-center justify-center transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-110 hover:-translate-y-1"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group w-12 h-12 rounded-xl bg-gradient-to-br from-black to-gray-900 hover:from-gray-900 hover:to-black flex items-center justify-center transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-110 hover:-translate-y-1 border border-gray-800"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group w-12 h-12 rounded-xl bg-gradient-to-br from-[#FF0000] to-[#E60000] hover:from-[#E60000] hover:to-[#FF0000] flex items-center justify-center transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-110 hover:-translate-y-1"
                  aria-label="YouTube"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group w-12 h-12 rounded-xl bg-gradient-to-br from-[#25D366] to-[#20BA5A] hover:from-[#20BA5A] hover:to-[#25D366] flex items-center justify-center transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-110 hover:-translate-y-1"
                  aria-label="WhatsApp"
                >
